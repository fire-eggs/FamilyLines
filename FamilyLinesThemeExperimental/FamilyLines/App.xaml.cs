...
namespace KBS.FamilyLines
{
    internal partial class App : Application
    {
        ...
        private void LoadLanguageResources()
        {
            ...
            FamilyLines.Properties.Resources.Culture = new CultureInfo("en-US");
            FamilyLinesLib.Properties.Resources.Culture = new CultureInfo("en-US");

            if (File.Exists(KBS.FamilyLines.Properties.Settings.Default.LanguagesFileName))
            {
                try
                {
                    FamilyLines.Properties.Resources.Culture = new CultureInfo(Settings.Default.Language);
                    FamilyLinesLib.Properties.Resources.Culture = new CultureInfo(Settings.Default.Language);
                }
                catch
                {
