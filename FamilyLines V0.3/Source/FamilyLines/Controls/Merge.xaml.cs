...
namespace KBS.FamilyLines
{
    ...
    public partial class Merge : System.Windows.Controls.UserControl
    {
        ...
        public bool CurrentPerson(int i)
        {
                ...
                OldPrefix.Content = existingPerson.Prefix;
                NewPrefix.Content = newPerson.Prefix;
                ...
                BirthImage.ToolTip = KBS.FamilyLines.Properties.Resources.ExistingCitation + " \n" + existingBirthCitation + "\n" + KBS.FamilyLines.Properties.Resources.NewCitation + " \n" + newBirthCitation;
                DeathImage.ToolTip = KBS.FamilyLines.Properties.Resources.ExistingCitation + " \n" + existingDeathCitation + "\n" + KBS.FamilyLines.Properties.Resources.NewCitation + " \n" + newDeathCitation;
                CremationImage.ToolTip = KBS.FamilyLines.Properties.Resources.ExistingCitation + " \n" + existingCremationCitation + "\n" + KBS.FamilyLines.Properties.Resources.NewCitation + " \n" + newCremationCitation;
                BurialImage.ToolTip =  KBS.FamilyLines.Properties.Resources.ExistingCitation + " \n" + existingBurialCitation + "\n" + KBS.FamilyLines.Properties.Resources.NewCitation + " \n" + newBurialCitation;

                OccupationImage.ToolTip = KBS.FamilyLines.Properties.Resources.ExistingCitation + " \n" + existingOccupationCitation + "\n" + KBS.FamilyLines.Properties.Resources.NewCitation + " \n" + newOccupationCitation;
                EducationImage.ToolTip = KBS.FamilyLines.Properties.Resources.ExistingCitation + " \n" + existingEducationCitation + "\n" + KBS.FamilyLines.Properties.Resources.NewCitation + " \n" + newEducationCitation;
                ReligionImage.ToolTip = KBS.FamilyLines.Properties.Resources.ExistingCitation + " \n" + existingReligionCitation + "\n" + KBS.FamilyLines.Properties.Resources.NewCitation + " \n" + newReligionCitation;
                ...
                if (Highlight(SuffixCheck, OldSuffix, NewSuffix))
                    highlightCount++;
                if (Highlight(PrefixCheck, OldPrefix, NewPrefix))
                    highlightCount++;
