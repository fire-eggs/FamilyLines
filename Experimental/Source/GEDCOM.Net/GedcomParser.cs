...
namespace GEDCOM.Net
{
	...
	public class GedcomParser
	{
		...
		private IndexedKeyCollection _tagCollection;
		private IndexedKeyCollection _xrefCollection;
		...
		/// </value>
		public IndexedKeyCollection TagCollection
		{
		...
		/// If not set one will be created when parsing.
		/// </value>
		public IndexedKeyCollection XrefCollection
		{
		...
		public bool GedcomParse(string data)
		{
			...
			{
				_tagCollection = new IndexedKeyCollection();
			}
			
			// same for Xrefs
			if (_xrefCollection == null)
			{
				_xrefCollection = new IndexedKeyCollection();
			}
