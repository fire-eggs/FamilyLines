                                     ...
                                     bool burials, bool deaths, bool cremations, bool births, bool marriages, bool divorces)
        {
            ...
            if (places)
            {
                ...
                if (deaths)
                {
                    ...
                    tw.WriteLine("<Folder>\n<name>" + KBS.FamilyLinesLib.Properties.Resources.Deaths + "</name>\n" +
                                 "<open>0</open>");
                ...
                {
                    tw.WriteLine("<Folder>\n" +
                                 "<name>" + KBS.FamilyLinesLib.Properties.Resources.Burials + "</name>\n" +
                                 "<open>0</open>");
                ...
                if (cremations)
                {
                    ...
                    tw.WriteLine("<Folder>\n" +
                                 "<name>" + KBS.FamilyLinesLib.Properties.Resources.Cremations + "</name>\n" +
                                 "<open>0</open>");
            ...
            else if(times)
            {
                ...
                tw.WriteLine("<Folder>\n" +
                             "<name>" + KBS.FamilyLinesLib.Properties.Resources.Events + "</name>\n" +
                             "<open>0</open>");
            ...
            summary[0] = i.ToString() + " " + KBS.FamilyLinesLib.Properties.Resources.PlacesExported;
