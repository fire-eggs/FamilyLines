...
namespace KBS.FamilyLines
{
    ...
    public partial class StoryViewer : System.Windows.Controls.UserControl
    {
        ...
        private void UserControl_IsVisibleChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            // KBR 03/11/2012 The family might have changed
		...
		// Check for this and load the note into the display.
        // TODO duplicated in PersonInfo.xaml.cs
        private void LoadStoryText(FlowDocument flowDocument)
        {
            ...
            Person person = StorysListBox.SelectedItem as Person;
