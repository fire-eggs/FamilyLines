    ...
    public class OPCUtility
    {
        ...
        private static void ExtractPart(PackagePart packagePart, string targetDirectory)
        {
            try
            {
				...
				// KBR 03/18/2012 Apply patch 6244 from shodi. Addresses the issue with stories
				// not saved/restored. Uri.LocalPath does not handle spaces in the filename.
				var localPath = Uri.UnescapeDataString(uriFullPartPath.LocalPath);
