...
namespace KBS.FamilyLines
{
    ...
    {
        int i;      // A counter for all duplicate people
        int count;  // Index of current person with differing info
        int total;  // Total number of people with differing info
        ...
        private void NextPerson()
        {
            ...
            do
            {
                ...
                if (i < App.FamilyCollection.ExistingPeopleCollection.Count)
                {
                    ...
                    if (total != 0)
                    {
                        FileProgressBar.Value = (count * 100.0) / total;
        ...
        private void SavePerson()
        {
            ...
            if (p1 != null && p2 != null)
            {
                ...
                {
                    p3.OccupationFact = p2.OccupationFact;
        ...
        /// </summary>
        /// <param name="persNum"></param>
        /// <returns></returns>
        public bool CurrentPerson(int persNum)
        {
                int highlightCount = 0;

                #region load the comparison

                Person existingPerson = App.FamilyCollection.ExistingPeopleCollection[persNum];
                Person newPerson = App.FamilyCollection.DuplicatePeopleCollection[persNum];
