...
namespace GEDCOM.Net
{
	...
	public class GedcomFamilyRecord : GedcomRecord
	{
		...
		private Dictionary<string, PedegreeLinkageType> _linkageTypes;
		private Dictionary<string, PedegreeLinkageType> _husbLinkageTypes;
		private Dictionary<string, PedegreeLinkageType> _wifeLinkageTypes;
		...
		public GedcomFamilyEvent Marriage
		{
			get
			{
				...
				{
					if (e.EventType == GedcomEvent.GedcomEventType.MARR)
					{
						marriage = e;
						break;
					}
		...
		public void SetLinkageType(string childXrefID, PedegreeLinkageType type)
		{
			SetLinkageType(childXrefID, type, GedcomAdoptionType.HusbandAndWife);
		}
		public void SetLinkageType(string childXrefID, PedegreeLinkageType type, GedcomAdoptionType to)
		{
		...
		public PedegreeLinkageType GetHusbandLinkageType(string childXrefID)
		{
			PedegreeLinkageType ret = PedegreeLinkageType.Unknown;
		...
		public PedegreeLinkageType GetWifeLinkageType(string childXrefID)
		{
			PedegreeLinkageType ret = PedegreeLinkageType.Unknown;
		...
		public PedegreeLinkageType GetLinkageType(string childXrefID)
		{
			PedegreeLinkageType ret = PedegreeLinkageType.Unknown;
			...
			foreach (string childID in _Children)
			{
				...
				if (child != null)
				{
					...
					if (child.ChildInFamily(_XrefID, out link))
					{
						...
						{
							case PedegreeLinkageType.FatherAdopted:
								sw.Write(Environment.NewLine);
								sw.Write(levelPlusTwo);
								sw.Write("_FREL Adopted");
								break;
							case PedegreeLinkageType.MotherAdopted:
								sw.Write(Environment.NewLine);
								sw.Write(levelPlusTwo);
