...
namespace Gedcom
{
	public class GedcomRecordedEvent
	{
		...
		private GedcomRecordList<GedcomEvent.GedcomEventType> _types;
		...
		public GedcomRecordList<GedcomEvent.GedcomEventType> Types
		{
			get 
			{ 
				if (_types == null)
				{
					_types = new GedcomRecordList<GedcomEvent.GedcomEventType>();
				}
